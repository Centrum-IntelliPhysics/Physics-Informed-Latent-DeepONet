...
n_used_values = [0, 100, 200]

# Iterate over each combination
for seed in seed_values:
    for n_used in n_used_values:
        # Construct the directory path
        resultdir = os.path.join(os.getcwd(), 'results', 'a_Vanilla-NO', f'seed={seed}_n_used={n_used}')
        ...
        command = f"sbatch --export=seed={seed},n_used={n_used},save={save} a_job_ROCKFISH_gpu.sh"
